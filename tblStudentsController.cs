...
namespace secondProject
{
    public class tblStudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,age,address,email,birthdate,password,classNum,isActive,isActive2")] tblStudent tblStudent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,age,address,email,birthdate,password,classNum,isActive,isActive2")] tblStudent tblStudent)
        {
            if (ModelState.IsValid)
            {
