...
namespace secondProject
{
    public class tblDepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,depName,depDescription,depNum")] tblDepartment tblDepartment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,depName,depDescription,depNum")] tblDepartment tblDepartment)
        {
            if (ModelState.IsValid)
            {
